    ...
    <div class="nk-block nk-block-lg">
        <div class="row">
            <div class="col-md-8 mb-5">
                <h4 class="nk-block-title">Tambah Dosen</h4>
            </div>
            <div class="col-md-4 mb-5 text-end">
                <a href="{{ route('admin.dosen.index') }}" class="btn btn-secondary"><em class="icon ni ni-bold-left"></em><span>Kembali</span> </a>
            </div>
        </div>
            ...
            <form method="POST" action="{{ route('admin.dosen.store') }}">
                ...
                <div class="form-group col-xl-6 col-md-8 col-sm-12">
                    <div class="form-label-group">
                        <label class="form-label" for="uniq_id">NIP</label>
                    </div>
